...
public class DataCollector4 {
    ...
    private void processFile(String filename) {
        System.out.println((System.currentTimeMillis() - beginTime) / 1000.0 +
                "s: Started processing " + filename);
        ...
        System.out.println((System.currentTimeMillis() - beginTime) / 1000.0 +
                "s: Finished processing " + filename);
...
//                | TimeoutException e
    ...
    public static void main(String[] args) throws FileNotFoundException {
        DataCollector4 dataCollector = new DataCollector4();
    }
}